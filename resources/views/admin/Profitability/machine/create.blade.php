...
<div class="container-fluid">
  <div class="card shadow col-md-10 mx-auto">
    <div class="card-header text-white" style="background-color:#6c757d; margin-left: -12px; margin-right: -12px;">
      <h5 class="m-0 font-weight-bold">{{ isset($profitability) ? 'Modifier' : 'Ajouter' }} la rentabilité</h5>
    </div>
    ...
    @else
      <form action="{{ route('machine#Create') }}" method="POST" enctype="multipart/form-data" id="profitabilityForm">
    @endif
      @csrf
      <div class="card-body" style="background-color:#6c757d; margin-left: -12px; margin-right: -12px;">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="date_profitability" id="date_profitability" class="form-control @error('date_profitability') is-invalid @enderror" value="{{ old('date_profitability', isset($profitability) ? $profitability->date_profitability->format('Y-m-d') : date('Y-m-d')) }}" required>
            ...
            <div class="mb-3">
                <label for="benefit" class="form-label fw-bold">Bénéfice</label>
          ...
          <div class="col-md-6">
            ...
            <!-- Prix de vente -->
            <div class="mb-3">
              <label for="selling_price" class="form-label fw-bold">Prix de vente</label>
              <input type="text" id="selling_price" name="selling_price" class="form-control font-weight-bold" readonly value="{{ old('selling_price', $profitability->selling_price ?? '') }}" style="background-color: #e9ecef;">
            </div>
          </div>
        </div>
        ...
        <div class="mt-3 d-flex justify-content-between align-items-center">
          <button type="submit" class="btn btn-success" style="background-color: rgb(249, 138, 27); border: none;">Enregistrer</button>
          <button type="button" id="btn_show_price" class="btn btn-info" style="background-color: rgb(144, 142, 140); border: none;">Afficher le prix de vente</button>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function updatePurchaseDetails(ref) {
    if (purchases[ref]) {
      ...
      if (purchase.suppliername) {
        supplierNameInput.value = purchase.suppliername;
        supplierNameHidden.value = purchase.suppliername;
      } else {
        supplierNameInput.value = '';
        supplierNameHidden.value = '';
      }
      if (purchase.weight !== null && purchase.weight !== undefined) {
      ...
      unitPurchasePriceHidden.value = '';
      purchaseWeightInput.value = '';
      weightHidden.value = '';
      purchaseBrandInput.value = '';
      brandHidden.value = '';
  ...
  if(globalUrbainTransportInput.value) {
    formatInputNumber(globalUrbainTransportInput, true);
    updateUrbanTransport();
  }
  ...
  showPriceButton.addEventListener('click', () => {
    ...
    sellingPriceInput.value = formatValue(prixVenteFinal);
    benefitInput.value = formatValue(valeurMarge);
  });
});
</script>
@endsection