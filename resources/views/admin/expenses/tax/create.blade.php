...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3" style="background-color:#6c757d;">
            <h5 class="m-0 font-weight-bold text-white">Enregistrer un Impôt</h5>
        </div>
        <form action="{{ route('taxStore') }}" method="POST">
            @csrf
            <div class="card-body" style="background-color:#6c757d;">
                ...
                <div class="row mt-4">
                    <div class="col-6"><button type="submit" class="btn w-100 text-white" style="background-color: rgb(249, 138, 27);">Ajouter</button></div>
...
function toggleDesc(select) {
    ...
    document.getElementById('description_other').required = select.value === 'Autres';
}
